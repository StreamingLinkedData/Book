package rsp4j.wspbook.wildstreams;
...
public class ProcessingWikimedia {
    ...
    public static void main(String[] args) throws IOException, ConfigurationException {
        ...
        DataStreamImpl<Graph> rdfStream =  mappedStream.map(e->parse(e), "http://example.org/test/rdf");
    ...
    public static Graph parse(String parseString) {
